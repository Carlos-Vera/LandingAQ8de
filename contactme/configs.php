...
$configs['from_name']				= 'EMS Training | Deutschland';					// Your name will be used in emails
...
$configs['recaptcha_secret']		= '6Ld08n4UAAAAAG04pnhb3ogJ1BTweWkN8GQ2YZtU';	// Google reCAPTCHA secret key
$configs['success_link']			= 'gluckwunsch.html';							// Link of a custom success page
...
$configs['smtp_secure']				= '';											// Choose the encryption: 'tls' or 'ssl'
$configs['smtp_port']				= 993;											// TCP port
// Upload management
